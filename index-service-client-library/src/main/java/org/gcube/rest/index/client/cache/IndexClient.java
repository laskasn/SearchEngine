...
public class IndexClient {
	...
	protected IndexClient(){} //should only be acquired by ClientFactory
	
	public void initiateClient(String zkConnStr){

		jerseyClient = Client.create();
		endpointProvider = new EndpointProvider(zkConnStr);
...
//						.accept(MediaType.APPLICATION_JSON + "; " + "charset=UTF-8")
				...
				logger.debug("Endpoint \""+ep+"\" seems to be malfunctioning.");
				
			} catch (Exception e) {
				logger.error("No index service found");
			}
			
		}
		throw new NoAvailableIndexServiceInstance("There are no available index services");
	}
